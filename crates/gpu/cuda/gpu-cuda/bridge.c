...
CUresult shrimply_cuda_primary_get_state(CUdevice device, unsigned *flags, int *active) { return 0; }
...
CUresult shrimply_cuda_stream_wait_event_flags(void *stream, void *event, unsigned flags) { return 0; }
...
CUresult shrimply_cuda_event_elapsed(float *milliseconds, void *start, void *end) { return 0; }
...
CUresult shrimply_cuda_import_external_semaphore(void **semaphore, const void *descriptor) { return 0; }
CUresult shrimply_cuda_wait_external_semaphores(const void *semaphores, const void *parameters, unsigned count, void *stream) { return 0; }
CUresult shrimply_cuda_destroy_external_semaphore(void *semaphore) { return 0; }
CUresult shrimply_cuda_graphics_map(unsigned count, void **resources, void *stream) { return 0; }
CUresult shrimply_cuda_graphics_unmap(unsigned count, void **resources, void *stream) { return 0; }
CUresult shrimply_cuda_graphics_mapped_array(void **array, void *resource, unsigned index, unsigned level) { return 0; }
...
CUresult shrimply_cuda_mem_advise_v2(uint64_t pointer, size_t bytes, unsigned advice, CUmemLocation location) { return 0; }
CUresult shrimply_cuda_mem_prefetch_v2(uint64_t pointer, size_t bytes, CUmemLocation location, unsigned flags, void *stream) { return 0; }
CUresult shrimply_cuda_mem_advise(uint64_t pointer, size_t bytes, unsigned advice, CUdevice device) { return 0; }
CUresult shrimply_cuda_mem_prefetch(uint64_t pointer, size_t bytes, CUdevice device, void *stream) { return 0; }
CUresult cuGraphicsGLRegisterImage(void *p_cuda_resource, uint32_t image, uint32_t target, uint32_t flags) { return 0; }
#else
#include <cuda.h>
#include <stddef.h>
#include <stdint.h>
